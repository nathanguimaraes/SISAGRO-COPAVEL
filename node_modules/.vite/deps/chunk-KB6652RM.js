...
addDecoder([8, 32946], () => import("./deflate-TYHJMRQY.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-TQATDB74.js").then((m) => m.default));
addDecoder(34887, () => import("./lerc-3RAQ5TCJ.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker2) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker2 ? Promise.resolve(createWorker2) : new Promise((resolve) => {
        import("./decoder-Z6WECGWR.js").then((module) => {
...
export {
  ...
  TileWMS_default,
  UTFGrid_default,
  WMTS_default2 as WMTS_default,
  sourcesFromTileGrid
};
//# sourceMappingURL=chunk-KB6652RM.js.map
