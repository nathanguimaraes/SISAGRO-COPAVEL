...
declare type RegionType$1 = 'template' | 'script' | 'style' | 'custom';
...
declare type LanguageId = 'vue' | 'vue-html' | 'pug' | 'css' | 'postcss' | 'scss' | 'sass' | 'less' | 'stylus' | 'javascript' | 'typescript' | 'tsx' | 'unknown';
...
declare type CodeActionData = RefactorActionData | CombinedFixActionData | OrganizeImportsActionData;
...
declare const createDependencyService: (rootPathForConfig: string, workspacePath: string, useWorkspaceDependencies: boolean, nodeModulesPaths: string[], tsSDKPath?: string | undefined) => Promise<DependencyService>;
...
declare class VueInterpolationMode implements LanguageMode {
    ...
    private vueDocuments;
    private vueInfoService?;
    constructor(tsModule: RuntimeLibrary['typescript'], serviceHost: IServiceHost, env: EnvironmentService, vueDocuments: LanguageModelCache<HTMLDocument>, vueInfoService?: VueInfoService | undefined);
    getId(): string;
    queryVirtualFileInfo(fileName: string, currFileText: string): {
        source: string;
        sourceMapNodesString: string;
